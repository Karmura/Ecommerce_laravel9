...
<body>
    <div id="app">
        ...
        <div class="container-fluid bg-dark border-bottom topnav">
            <div class="container">
                {{-- remove link from brand if user is admin --}}
                {{-- <a class="navbar-brand" href="{{ url('/') }}">
          {{ config('app.name', 'Laravel') }}
        </a> --}}
                <header
                    class="d-flex align-items-center justify-content-center justify-content-md-between flex-wrap py-3">
                    <a href="/"
                        class="d-flex align-items-center col-md-3 mb-md-0 text-dark text-decoration-none logo">
                    </a>
                    <ul class="nav col-md-auto justify-content-center mb-md-0 top">
                        <li class="{{ Request::segment(1) == '' ? 'active' : '' }}">
                            <a href="" class="nav-link link-light px-4">Home</a>
                        </li>
                        <li class="{{ Request::segment(1) == 'features' ? 'active' : '' }}">
                            <a href="" class="nav-link link-secondary px-4">Features</a>
                        </li>
                        <li>
                    ...
                    <div class="col-md-2 menuicons text-end">
                        ...
                        @else
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item textgrey" href="{{ url('/') }}"
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="{{ asset('images/Q6Xkj4dyUFiBhOshVXO6KBY2LIf7ot7u1175pGhW.jpg') }}"
              ...
              <p>Some representative placeholder content for the first slide.</p>
                ...
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="{{ asset('images/u2hhaolUGbJJziaRb0q2Z0RMXAFn3d8bwSQmCWLB.jpg') }}"
                        class="d-block w-100" alt="..." />
                    <!-- <div class="carousel-caption d-none d-md-block">
              ...
              <p>Some representative placeholder content for the second slide.</p>
                ...
                <div class="carousel-item">
                    <img src="{{ asset('images/Mkbwlji4fjDRGw3njgatWmqUghdNGF3J7n1opb66.jpg') }}"
                        class="d-block w-100" alt="..." />
                    <!-- <div class="carousel-caption d-none d-md-block">
        ...
        <div id="carouselExampleDarkMobile" class="carousel carousel-dark slide mobile" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#carouselExampleDarkMobile" data-bs-slide-to="0"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="{{ asset('images/mobile_slider_image.jpg') }}" class="d-block w-100" alt="..." />
                    <!-- <div class="carousel-caption d-none d-md-block">
            <h5>First slide label</h5>
            <p>Some representative placeholder content for the first slide.</p>
          </div> -->
                ...
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="{{ asset('images/mobile_slider_img2.jpg') }}" class="d-block w-100" alt="..." />
                    <!-- <div class="carousel-caption d-none d-md-block">
            <h5>Second slide label</h5>
            <p>Some representative placeholder content for the second slide.</p>
          </div> -->
                ...
                <div class="carousel-item">
                    <img src="{{ asset('images/mobile_slider_img3.jpg') }}" class="d-block w-100" alt="..." />
                    <!-- <div class="carousel-caption d-none d-md-block">
            <h5>Third slide label</h5>
            <p>Some representative placeholder content for the third slide.</p>
          </div> -->
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleDarkMobile"
                data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleDarkMobile"
                data-bs-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Next</span>
            </button>
        ...
        <div class="container">
            <img src="{{ asset('images/tkUl8fPnYajcxroizmqgXTe0M3A741zLNdSDfnY5.png') }}" class="img-fluid"
                alt="..." />

            <div class="td-mini-mgr-top overflow-hidden text-center">
                <div class="row gy-2">
                    <div class="col-4">
        ...
        "
            ...
            <!-- pagination -->
            <nav aria-label="..." class="pagicontainer td-medium-mgr-top">
                <ul class="pagination">
    ...
    <footer class="td-medium-mgr-top">
        <ul class="nav justify-content-center mb-3">
            <li class="nav-item">
                <a href="#" class="nav-link text-muted px-2">Home</a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link text-muted px-2">Features</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link text-muted px-2">About</a>
            </li>
        </ul>
        <a class="nav-link">Copyright ©2022-2050 All Rights Reserved</a>
    </footer>
